...
void
img::EasyImage::draw_triangle(ZBuffer &zBuffer, const Vector3D &a, const Vector3D &b, const Vector3D &c, const double d,
							  const double dx, const double dy, const img::Color &color) {
	struct point {
		double x;
		double y;
